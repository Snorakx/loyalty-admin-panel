...
import styles from './DeleteLocationConfirmation.module.scss';
...
export const DeleteLocationConfirmation: React.FC<DeleteLocationConfirmationProps> = ({
  isOpen,
  onClose,
  onConfirm,
  locationName,
  ...
  const expectedText = `${locationName}, ${locationCity}`;
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      console.error('Error requesting location deletion:', error);
  ...
  return (
    <Drawer
      isOpen={isOpen}
      onClose={handleClose}
      title="Zażądaj usunięcia lokalizacji"
    >
        ...
        {!isRequestSent ? (
          <>
            <div className={styles.warning}>
              ...
              <h2>Czy na pewno chcesz zażądać usunięcia tej lokalizacji?</h2>
              <p>
            ...
            <div className={styles.consequences}>
              ...
              <ul>
                <li>Lokalizacja: <strong>{locationName}</strong> w <strong>{locationCity}</strong></li>
                <li>Wszystkie dane tej lokalizacji</li>
                <li>Wszystkie karty klientów przypisane do tej lokalizacji</li>
                <li>Wszystkie stemple i historię z tej lokalizacji</li>
                <li>Wszystkich pracowników przypisanych do tej lokalizacji</li>
              </ul>
            </div>
            ...
            <div className={styles.confirmation}>
              ...
              <p>
                Aby wysłać żądanie usunięcia, wpisz nazwę lokalizacji z miastem: <strong>{expectedText}</strong>
              </p>
              
              <FormField
                label="Nazwa lokalizacji z miastem"
                value={confirmationText}
                onChange={setConfirmationText}
                placeholder={`Wpisz "${expectedText}" aby potwierdzić`}
          ...
          <div className={styles.success}>
            ...
            <p>
              Twoje żądanie usunięcia lokalizacji <strong>{locationName}</strong> w <strong>{locationCity}</strong> zostało wysłane do administratora.
            </p>
            <p>
            ...
            <ul className={styles.nextSteps}>
              ...
              <li>W przypadku zatwierdzenia, wszystkie dane lokalizacji zostaną usunięte</li>
            </ul>
            <div className={styles.actions}>
              <Button
                variant="primary"
